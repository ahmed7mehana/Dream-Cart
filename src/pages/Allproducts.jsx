...
console.log(products.products)
  ...
  return (
      ...
      <h2 className=' text-4xl m-10 font-bold uppercase'>PRODUCTs</h2>
  

    <div  className='flex flex-wrap m-auto justify-center mb-10 '>
    {products.products.map((product)=>(
      ...
      <h2 className=' uppercase font-bold text-sm flex  mr-2 '>{product.name} (  <AiOutlineStar className=' text-green-500'  size={25}/> )</h2>
