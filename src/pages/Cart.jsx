...
console.log(products.products.buy)
...
{cart.length>0?(
  ...
  {cart.map((item)=>(
    ...
    <td style={{ width: '10%', padding:'0' ,textAlign:'center'  }} > <Link className=' uppercase font-bold text-sm' href={products.products[item.id-1].buy}>buy</Link> </td>
